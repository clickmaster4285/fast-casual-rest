...
const HeroSection = () => {
  ...
  return (
    <section ref={heroRef} className="relative h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-surface-1/40 via-surface-1/40 to-surface-1" />
      ...
      <div className="relative z-10 container mx-auto h-full flex flex-col justify-center px-4 md:px-8">
        ...
        <h1 className="font-heading text-4xl md:text-6xl lg:text-5xl font-bold leading-tight mb-6">
  Serve with Speed.{" "}
  ...
  <span className="text-primary">Effortlessly.</span>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <button
              ...
              className="px-8 py-4 rounded-lg border border-primary/50 text-foreground font-heading font-semibold hover:border-primary/50 hover:bg-primary/5 transition-all duration-300"
            >
              See Features
            </button>
          </div>
        ...
        <div ref={statsRef} className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-12 max-w-3xl">
          {stats.map((stat) => (
            <div key={stat.label} className=" animate-float" style={{ animationDelay: `${Math.random() * 2}s` }}>
